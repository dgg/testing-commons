...
namespace Testing.Commons.Time
{
	...
	public static class TimeExtensions
	{
		...
		public class TimeOfDay
		{
			...
			/// </summary>
			public readonly TimeSpan Noon = new TimeSpan(0, 12, 0, 0, 0);
			/// <summary>
			...
			/// </summary>
			public readonly TimeSpan EndOfDay = new TimeSpan(0, 23, 59, 59, 999);
			/// <summary>
			/// Middle of the night, twelve o'clock at night.
			/// </summary>
			public readonly TimeSpan BeginningOfDay = TimeSpan.Zero;

			internal static TimeOfDay Instance = new TimeOfDay();
		}
