...
namespace Testing.Commons.NUnit.Constraints
{
	internal static class Name
	{
		...
		{
			return getMemberExpression(property).Member as PropertyInfo;
		}
		...
		private static MemberExpression getMemberExpression<TObject>(Expression<Func<TObject, object>> property)
		{
			...
			if (memberExpression == null) throw new ArgumentException(Exceptions.NotMemberExpression, "property");
