...
{
	public class RaisesPropertyChangedConstraint<T> : Constraint where T : INotifyPropertyChanged
	{
		private readonly T _source;
		private readonly Constraint _matchingPropertyName;

		public RaisesPropertyChangedConstraint(T source, Expression<Func<T, object>> property)
		{
			_source = source;
